export const USERS = [
  ...
  { id: 17, name: 'Isabelle Uwera', email: 'cfo@saltel.rw', role: 'cfo', avatar: 'IU', dept: null, phone: '+250788000017', profile_pic: null, hire_date: '2014-03-01', salary: 750000, username: 'cfo', password: 'saltel', qualifications: { studies: 'MBA Finance - KIE', certifications: ['CPA Rwanda', 'CFA Level 2'], experience: '12 years in corporate finance', licenses: ['B'] } },
  { id: 18, name: 'Bernard Nkusi', email: 'cbo@saltel.rw', role: 'cbo', avatar: 'BN', dept: null, phone: '+250788000018', profile_pic: null, hire_date: '2015-06-15', salary: 700000, username: 'cbo', password: 'saltel', qualifications: { studies: 'MBA Business - USIU', certifications: ['PMP', 'Six Sigma Green Belt'], experience: '11 years in business operations', licenses: ['B'] } },
  { id: 19, name: 'Celestine Mukeshimana', email: 'dm@saltel.rw', role: 'dm', avatar: 'CM', dept: null, phone: '+250788000019', profile_pic: null, hire_date: '2016-09-01', salary: 650000, username: 'dm', password: 'saltel', qualifications: { studies: 'BSc Management - UR', certifications: ['PMP', 'PRINCE2'], experience: '10 years in project/division management', licenses: ['A0'] } },
  ...
  { id: 2, name: 'Patrick Habimana', email: 'hod.lan@saltel.rw', role: 'regional_coordinator', avatar: 'PH', dept: 'LAN', phone: '+250788000002', profile_pic: null, hire_date: '2016-03-01', salary: 650000, username: 'hod.lan', password: 'saltel', qualifications: { studies: 'BSc Computer Networks - UR', certifications: ['CCNP', 'CompTIA Network+'], experience: '10 years in LAN/WAN infrastructure', licenses: ['A0'] } },
  { id: 3, name: 'Alice Mukamana', email: 'hod.fiber@saltel.rw', role: 'regional_coordinator', avatar: 'AM', dept: 'Fiber', phone: '+250788000003', profile_pic: null, hire_date: '2017-01-10', salary: 650000, username: 'hod.fiber', password: 'saltel', qualifications: { studies: 'BSc Telecommunications - INES', certifications: ['CFOS', 'FOA'], experience: '9 years in Fiber Optic Networks', licenses: ['A0'] } },
  { id: 4, name: 'Eric Niyonzima', email: 'hod.cctv@saltel.rw', role: 'regional_coordinator', avatar: 'EN2', dept: 'CCTV', phone: '+250788000004', profile_pic: null, hire_date: '2018-02-20', salary: 650000, username: 'hod.cctv', password: 'saltel', qualifications: { studies: 'BSc Electronic Engineering - KIM', certifications: ['CCTV Certified', 'CompTIA Security+'], experience: '8 years in Security Systems', licenses: ['A1'] } },
  { id: 5, name: 'Grace Uwimana', email: 'lead.lan@saltel.rw', role: 'unit_leader', avatar: 'GU', dept: 'LAN', phone: '+250788000005', profile_pic: null, hire_date: '2020-06-01', salary: 450000, username: 'lead.lan', password: 'saltel', qualifications: { studies: 'BSc IT - UR', certifications: ['CCNA', 'Network+'], experience: '6 years field experience', licenses: ['A1'] } },
  { id: 6, name: 'David Hakizimana', email: 'lead.fiber@saltel.rw', role: 'unit_leader', avatar: 'DH', dept: 'Fiber', phone: '+250788000006', profile_pic: null, hire_date: '2019-07-15', salary: 450000, username: 'lead.fiber', password: 'saltel', qualifications: { studies: 'BEng Telecom - INES', certifications: ['CFOS', 'FOA Installer'], experience: '7 years fiber splicing', licenses: ['A1'] } },
  { id: 7, name: 'Sandra Uwase', email: 'lead.cctv@saltel.rw', role: 'unit_leader', avatar: 'SU', dept: 'CCTV', phone: '+250788000007', profile_pic: null, hire_date: '2021-04-01', salary: 450000, username: 'lead.cctv', password: 'saltel', qualifications: { studies: 'BSc Security Systems - KIM', certifications: ['Axis Certified', 'Hikvision Certified'], experience: '5 years CCTV installation', licenses: ['A1'] } },
  { id: 20, name: 'Olivier Habimana', email: 'staff.oh@saltel.rw', role: 'staff', avatar: 'OH', dept: 'LAN', phone: '+250788000020', profile_pic: null, hire_date: '2024-01-15', salary: 380000, username: 'staff.oh', password: 'saltel', qualifications: { studies: 'DIT - IPRC Kigali', certifications: ['CompTIA A+'], experience: '2 years IT support', licenses: ['Ad'] } },
  ...
  { id: 15, name: 'Solange Nyiraneza', email: 'accountant@saltel.rw', role: 'maximization_officer', avatar: 'SN', dept: null, phone: '+250788000015', profile_pic: null, hire_date: '2020-02-10', salary: 400000, username: 'accountant', password: 'saltel', qualifications: { studies: 'BBA Accounting - SFB', certifications: ['CPA Rwanda', 'ACCA (in progress)'], experience: '6 years in financial management', licenses: [] } },
  { id: 21, name: 'Pacifique Nzeyimana', email: 'storekeeper@saltel.rw', role: 'store_keeper', avatar: 'PN', dept: null, phone: '+250788000021', profile_pic: null, hire_date: '2022-08-01', salary: 360000, username: 'storekeeper', password: 'saltel', qualifications: { studies: 'BBA Logistics - SFB', certifications: ['Supply Chain Management'], experience: '4 years in inventory & stores management', licenses: ['A1'] } },
];
...
export const BASE_SALARIES = {
  ceo: 1200000, cfo: 750000, cbo: 700000, dm: 650000, daf: 700000,
  regional_coordinator: 650000, unit_leader: 450000, technician: 320000,
  maximization_officer: 400000, staff: 380000, store_keeper: 360000,
};
...
export const INITIAL_PAYMENTS = [
  ...
  { id: 'PAY-007', task_id: 'T-006', technician_id: 14, transport: 5000, meals: 33000, lodging: 0, total: 38000, status: 'pending', method: 'MoMo', ref: null, paid_at: null, notes: 'BK Arena CCTV', disputed: true, dispute_reason: 'Lodging was provided but not reimbursed.', dispute_status: 'open', dispute_target: 'maximization_officer' },
];
...
export const INITIAL_ANNOUNCEMENTS = [
  ...
  { id: 'ANN-002', from_user_id: 2, target: 'unit_leader', target_dept: 'LAN', title: 'LAN Team — Weekly Sync', body: 'Monday 8:30am in Conference Room B. Mandatory for all unit leaders.', created_at: '2026-04-09T10:30:00', pinned: false },
...
export const ROLE_CONFIG = {
  ...
  cfo: { label: 'CFO', color: '#0EA5E9' },
  cbo: { label: 'CBO', color: '#8B5CF6' },
  dm: { label: 'DM', color: '#F59E0B' },
  daf: { label: 'DAF', color: '#EC4899' },
  regional_coordinator: { label: 'Regional Coordinator', color: '#169BD5' },
  unit_leader: { label: 'Unit Leader', color: '#06B6D4' },
  technician: { label: 'Field Technician', color: '#10B981' },
  maximization_officer: { label: 'Maximization Officer', color: '#F97316' },
  staff: { label: 'Staff', color: '#64748B' },
  store_keeper: { label: 'Store Keeper', color: '#14B8A6' },
};

export const STATUS_LABELS = {
  ceo_created: 'Pending Regional Coordinator',
  hod_created: 'Pending Unit Leader',
  leader_assigned: 'Pending Technicians',
  supervisor_approval_pending: 'Awaiting RC Approval',
...
export const buildPerformance = (tasks, reports, usersOverride) => {
  ...
  return pool.filter(u => ['technician', 'unit_leader', 'staff'].includes(u.role)).map(u => {
    ...
    return { user_id: u.id, tasks_total: myTasks.length, tasks_completed: completed, reports_total: myReports.length, avg_score: avgScore, score: avgScore, on_time_pct: pct };
  });
};
