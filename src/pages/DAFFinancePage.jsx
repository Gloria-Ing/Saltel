...
export default function DAFFinancePage() {
  ...
  if (!['daf', 'cfo'].includes(currentUser?.role)) {
    return <div style={{ padding: '2rem', textAlign: 'center', color: 'var(--text3)' }}>Access restricted to DAF and CFO.</div>;
  }
  ...
  return (
    <div>
      <PageHeader title="💎 Finance Dashboard" subtitle={currentUser?.role === 'cfo' ? 'CFO — Financial Administration & Overview' : 'DAF — Director of Administration & Finance'} />
