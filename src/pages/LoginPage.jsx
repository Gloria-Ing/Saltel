...
const DEMO_CREDS = {
  ...
  'cfo@saltel.rw': { id: 17, pass: 'saltel' },
  'cbo@saltel.rw': { id: 18, pass: 'saltel' },
  'dm@saltel.rw': { id: 19, pass: 'saltel' },
  ...
  'staff.oh@saltel.rw': { id: 20, pass: 'saltel' },
  'storekeeper@saltel.rw':  { id: 21, pass: 'saltel'  },
...
export default function LoginPage() {
  ...
  const QUICK = [
    ...
    { label: 'CFO', email: 'cfo@saltel.rw', pass: 'saltel', color: '#0EA5E9' },
    { label: 'CBO', email: 'cbo@saltel.rw', pass: 'saltel', color: '#8B5CF6' },
    { label: 'DM', email: 'dm@saltel.rw', pass: 'saltel', color: '#F59E0B' },
    { label: 'DAF', email: 'daf@saltel.rw', pass: 'saltel', color: '#EC4899' },
    { label: 'Regional Coordinator', email: 'hod.lan@saltel.rw', pass: 'saltel', color: '#169BD5' },
    { label: 'Unit Leader', email: 'lead.lan@saltel.rw', pass: 'saltel', color: '#06B6D4' },
    { label: 'Staff', email: 'staff.oh@saltel.rw', pass: 'saltel', color: '#64748B' },
    { label: 'Field Technician', email: 'tech.jb@saltel.rw', pass: 'saltel', color: '#10B981' },
    { label: 'Maximization Officer', email: 'accountant@saltel.rw', pass: 'saltel', color: '#F97316' },
    { label: 'Store Keeper', email: 'storekeeper@saltel.rw', pass: 'saltel', color: '#14B8A6' },
  ];
      ...
      <div style={{ display: 'flex', width: '100%', position: 'relative', zIndex: 1, flexWrap: 'wrap' }}>
        ...
        <div className="login-brand-panel" style={{ width: '45%', display: 'flex', flexDirection: 'column', padding: '3rem 3.5rem', position: 'relative', borderRight: '1px solid #E0ECF8', background: '#FFFFFF' }}>
          ...
          <div style={{ marginTop: 'auto', display: 'flex', gap: 12 }}>
            {[{ n: '20+', l: 'Staff' }, { n: '3', l: 'Units' }, { n: '7+', l: 'Sites' }, { n: 'V13', l: 'Version' }].map(s => (
